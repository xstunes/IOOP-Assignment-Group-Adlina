...
namespace IOOP_Assignment_Group_Adlina
{
    internal class Reservation
    {
        ...
        public Reservation(string customerID, string amountPeople, string eventDate, string eventHall, string rsvStatus)
        {
        ...
        public string CustomerReservation()
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into reservation(customerID,amountPeople,eventDate,eventHall,rsvStatus) values(@id ,@ppl,@dt , @hl , @st);", con);
        ...
        public string UpdateReservation()
        {
            ...
            SqlCommand cmd = new SqlCommand("update reservation set amountPeople=@ppl,eventDate=@dt,eventHall=@hl,rsvStatus=@st where customerID=@id", con);
            cmd.Parameters.AddWithValue("@id", customerID);
            cmd.Parameters.AddWithValue("@ppl", amountPeople);
            cmd.Parameters.AddWithValue("@dt", DateTime.Parse(eventDate));
            cmd.Parameters.AddWithValue("@hl", eventHall);
